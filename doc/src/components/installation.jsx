...
const Installation = () => {
  return (
    <div className="p-6 bg-white md:p-8 lg:p-10">
      <Typography variant="h4" className="mb-6 text-gray-800 text-center md:text-left">
        Installation
      </Typography>
      ...
      <Typography variant="h5" className="mt-10 mb-6 text-gray-800 text-center md:text-left">
        Features
      </Typography>
      <ul className="list-disc list-inside mb-6 text-gray-700 leading-relaxed space-y-4">
        <li className="mb-2">
      ...
      <SyntaxHighlighter language="bash" style={coy} className="mb-6">
      ...
      <SyntaxHighlighter language="javascript" style={coy} className="mb-6">
...
server.listen(8080, () => {
    console.log('Server is running on port 8080');
      ...
      <Typography variant="h4" className="mt-8 mb-4 text-gray-800 text-center md:text-left">
        Routing
      </Typography>
      <Typography variant="body1" className="mb-6 text-gray-700 leading-relaxed">
