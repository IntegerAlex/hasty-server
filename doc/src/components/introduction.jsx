...
const Introduction = () => {
  return (
    <div className=" bg-[#0F1115] w-full min-h-screen p-6 shadow-lg rounded-lg md:p-8 lg:p-10">
      <Typography
        variant="h4"
      ...
      <Typography
        variant="body1"
        className="mb-6 text-[#B2A49B] leading-relaxed"
      >
      ...
      <ul className="list-disc list-inside mb-6 pl-6 text-[#B2A49B] leading-relaxed">
        <li className="mb-2">
          <strong className="text-[#A6A4A0]">API Development:</strong> Easily create robust APIs to handle client requests 
          and serve dynamic data, making it perfect for modern web applications.
        </li>
        <li className="mb-2">
          <strong className="text-[#A6A4A0]" >File Serving:</strong> Efficiently serve static files, including HTML, CSS, 
          JavaScript, and images, ensuring quick delivery to clients.
        </li>
        <li className="mb-2">
          <strong className="text-[#A6A4A0]">Express-like Functionality:</strong> Hasty Server provides a simple, 
        ...
        <li className="mb-2">
          <strong className="text-[#A6A4A0]">High Performance:</strong> Optimized for speed and efficiency, capable of 
          handling multiple requests simultaneously.
        </li>
        <li className="mb-2">
          <strong className="text-[#A6A4A0]">Extensible:</strong> Easily extend functionality with custom middleware 
          and plugins tailored to your specific needs.
        </li>
        <li className="mb-2">
          <strong className="text-[#A6A4A0]">Secure:</strong> Built-in security features to protect your applications 
          and data.
